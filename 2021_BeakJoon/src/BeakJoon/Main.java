...
public class Main {
	...
	public static void a_1712_손익분기점() {
		Scanner input = new Scanner(System.in);

		int fixedCosts = input.nextInt();
		int variableCosts = input.nextInt();
		int prices = input.nextInt();

		if (variableCosts >= prices) {
			System.out.println(-1);
		}

		else {
			System.out.println((fixedCosts / (prices - variableCosts)) + 1);
		}
	}
