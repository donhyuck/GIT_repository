...
public class MemberController extends Controller {
	...
	private void showWhoAmI() {
		...
		System.out.println("== 로그인 중인 회원의 정보 ==");
	...
	public void doJoin() {
		...
		while (true) {
			...
			if (isJoinableLoginId(loginId) == false) {
				System.out.printf("%s는 이미 사용중인 아이디입니다.", loginId);
				continue;
			}
	...
	public void makeTestData() {
		...
		members.add(new Member(1, Util.getCurrentDate(), "test1", "test1", "회원1"));
		members.add(new Member(1, Util.getCurrentDate(), "test2", "test2", "회원2"));
	}
