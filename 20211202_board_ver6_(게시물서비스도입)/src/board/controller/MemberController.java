...
//	private List<Member> members;  -> 맴버서비스를 만들며 삭제 (dao에서 Arraylist생성)
	private Scanner sc;
...
//		members = Container.memberDao.members;  -> 맴버서비스를 만들며 삭제
		this.sc = sc;
...
//		Member member = getMemberByLoginId(loginId);
		// 그냥 getMemberByLoginId 가 아니라 서비스에서 가져오도록
	...
	public void makeTestData() {
		...
		Container.memberDao
				.add(new Member(Container.memberDao.getNewId(), Util.getCurrentDate(), "test2", "test2", "김철수"));
	}
